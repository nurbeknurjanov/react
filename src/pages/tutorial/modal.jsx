...
function ModalSwitch() {
    ...
    return (
        <div>
            ...
            {/* After category when one of image is clicked */}
            {backgroundLocation && <Route path="/img/:id" children={<Modal />} />}
        </div>
    );
}
...
function Gallery() {
    let galleryLocation = useLocation();
            ...
            {IMAGES.map(i => (
                <Link
                    ...
                    to={{
                        ...
                        state: { backgroundLocation: galleryLocation }
                    }}
                >
